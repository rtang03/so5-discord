...
export const ETHEREUM_RPC_URL = getParamOrExit(
  typeof window === 'undefined' ? 'ETHEREUM_RPC_URL' : 'NEXT_PUBLIC_ETHEREUM_RPC_URL'
);

export const LENS_API = getParamOrExit(
  typeof window === 'undefined' ? 'LENS_API' : 'NEXT_PUBLIC_LENS_API'
);
